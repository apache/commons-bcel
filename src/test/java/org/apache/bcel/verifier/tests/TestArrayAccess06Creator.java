...
/**
 * Emits a method that applies {@code caload} to an {@code int[]} reference. The {@code caload} instruction requires a
 * {@code char[]}, so applying it to an array with a different component type is illegal and structural verification must
 * reject it.
 */
public class TestArrayAccess06Creator extends TestCreator {
    ...
    public TestArrayAccess06Creator() {
        cg = new ClassGen(TEST_PACKAGE + ".TestArrayAccess06", "java.lang.Object", "TestArrayAccess06.java", Const.ACC_PUBLIC | Const.ACC_SUPER,
            new String[] {});
    ...
    private void createMethod_0() {
        ...
        final MethodGen method = new MethodGen(Const.ACC_PUBLIC, Type.VOID, Type.NO_ARGS, new String[] {}, "<init>", TEST_PACKAGE + ".TestArrayAccess06", il, cp);
