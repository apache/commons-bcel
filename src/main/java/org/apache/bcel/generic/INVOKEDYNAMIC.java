...
public class INVOKEDYNAMIC extends InvokeInstruction {
     ...
     *
     * Note: Contrary to this method's name it does not return the classname of the
     * invoke target; rather it returns the name of the method that will be used to
